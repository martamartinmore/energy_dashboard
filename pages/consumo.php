<?php
  ...
  $consumo = array();
  for ($i = 1; $i <= 31; $i++) {
    $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE DAY(fecha) = '$i'";
    $result = $conn->query($sql);  
    
    if ($result->num_rows > 0) {
      while($row = $result->fetch_assoc()) {
        array_push($consumo, $row["suma"]);
      }
    } else {
      array_push($consumo, 0);
    }
  }
  
  // ---- CONSUMO TOTAL EN EL MES ACTUAL POR SALAS ----

  // ---- OFICINAS -----
  $consumo_salas_oficinas = array();
  for ($i = 1; $i <= 31; $i++) {
    $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE DAY(fecha) = '$i' AND sala_id in ( SELECT id FROM Salas WHERE tipo = 'Oficinas'";
    $result = $conn->query($sql);  
    
    if ($result->num_rows > 0) {
      while($row = $result->fetch_assoc()) {
        array_push($consumo_salas_oficinas, $row["suma"]);
      }
    } else {
      array_push($consumo_salas_oficinas, 0);
    }
  }

    // ---- COMUNES -----
    $consumo_salas_comunes = array();
    for ($i = 1; $i <= 31; $i++) {
      $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE DAY(fecha) = '$i' AND sala_id in ( SELECT id FROM Salas WHERE tipo = 'Comunes'";
      $result = $conn->query($sql);  
      
      if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
          array_push($consumo_salas_comunes, $row["suma"]);
        }
      } else {
        array_push($consumo_salas_comunes, 0);
      }
    }

      // ---- WORKSPACE -----
  $consumo_salas_workspace = array();
  for ($i = 1; $i <= 31; $i++) {
    $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE DAY(fecha) = '$i' AND sala_id in ( SELECT id FROM Salas WHERE tipo = 'Workspace'";
    $result = $conn->query($sql);  
    
    if ($result->num_rows > 0) {
      while($row = $result->fetch_assoc()) {
        array_push($consumo_salas_workspace, $row["suma"]);
      }
    } else {
      array_push($consumo_salas_workspace, 0);
    }
  }

    // ---- REUNION -----
    $consumo_salas_reunion = array();
    for ($i = 1; $i <= 31; $i++) {
      $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE DAY(fecha) = '$i' AND sala_id in ( SELECT id FROM Salas WHERE tipo = 'Reunion'";
      $result = $conn->query($sql);  
      
      if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
          array_push($consumo_salas_reunion, $row["suma"]);
        }
      } else {
        array_push($consumo_salas_reunion, 0);
      }
    }

  

  // ---- CONSUMO MENSUAL EN CADA SALA ----
  $mes_actual = date("m");

  // ---- SALA 1 -----
  $consumo_sala_1 = array();  
  for ($i = 1; $i <= 12; $i++) {
    $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE MONTH(fecha) = '$i' AND YEAR(fecha) = 2023 AND sala_id = 0";
    $result = $conn->query($sql);  
    
    if ($result->num_rows > 0) {
      while($row = $result->fetch_assoc()) {
        array_push($consumo_sala_1, $row["suma"]);
      }
    } else {
      array_push($consumo_sala_1, 0);
    }
  }

    // ---- SALA 2 -----
    $consumo_sala_2 = array();  
    for ($i = 1; $i <= 12; $i++) {
      $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE MONTH(fecha) = '$i' AND YEAR(fecha) = 2023 AND sala_id = 1";
      $result = $conn->query($sql);  
      
      if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
          array_push($consumo_sala_2, $row["suma"]);
        }
      } else {
        array_push($consumo_sala_2, 0);
      }
    }

      // ---- SALA 3 -----
  $consumo_sala_3 = array();  
  for ($i = 1; $i <= 12; $i++) {
    $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE MONTH(fecha) = '$i' AND YEAR(fecha) = 2023 AND sala_id = 2";
    $result = $conn->query($sql);  
    
    if ($result->num_rows > 0) {
      while($row = $result->fetch_assoc()) {
        array_push($consumo_sala_3, $row["suma"]);
      }
    } else {
      array_push($consumo_sala_3, 0);
    }
  }

    // ---- SALA 4 -----
    $consumo_sala_4 = array();  
    for ($i = 1; $i <= 12; $i++) {
      $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE MONTH(fecha) = '$i' AND YEAR(fecha) = 2023 AND sala_id = 3";
      $result = $conn->query($sql);  
      
      if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
          array_push($consumo_sala_4, $row["suma"]);
        }
      } else {
        array_push($consumo_sala_4, 0);
      }
    }

      // ---- SALA 5 -----
  $consumo_sala_5 = array();  
  for ($i = 1; $i <= 12; $i++) {
    $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE MONTH(fecha) = '$i' AND YEAR(fecha) = 2023 AND sala_id = 4";
    $result = $conn->query($sql);  
    
    if ($result->num_rows > 0) {
      while($row = $result->fetch_assoc()) {
        array_push($consumo_sala_5, $row["suma"]);
      }
    } else {
      array_push($consumo_sala_5, 0);
    }
  }

    // ---- SALA 6 -----
    $consumo_sala_6 = array();  
    for ($i = 1; $i <= 12; $i++) {
      $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE MONTH(fecha) = '$i' AND YEAR(fecha) = 2023 AND sala_id = 5";
      $result = $conn->query($sql);  
      
      if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
          array_push($consumo_sala_6, $row["suma"]);
        }
      } else {
        array_push($consumo_sala_6, 0);
      }
    }

      // ---- SALA 7 -----
  $consumo_sala_7 = array();  
  for ($i = 1; $i <= 12; $i++) {
    $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE MONTH(fecha) = '$i' AND YEAR(fecha) = 2023 AND sala_id = 6";
    $result = $conn->query($sql);  
    
    if ($result->num_rows > 0) {
      while($row = $result->fetch_assoc()) {
        array_push($consumo_sala_7, $row["suma"]);
      }
    } else {
      array_push($consumo_sala_7, 0);
    }
  }

    // ---- SALA 8 -----
    $consumo_sala_8 = array();  
    for ($i = 1; $i <= 12; $i++) {
      $sql = "SELECT SUM(valor) suma FROM Dispositivos WHERE MONTH(fecha) = '$i' AND YEAR(fecha) = 2023 AND sala_id = 7";
      $result = $conn->query($sql);  
      
      if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
          array_push($consumo_sala_8, $row["suma"]);
        }
      } else {
        array_push($consumo_sala_8, 0);
      }
    }
...
<!-- css style -->
<link href="../css/consumo_style.css" rel="stylesheet" />
    ...
    <svg style="display:none;">
      ...
      <br>
        ...
        <script type="text/javascript">
          const consumo_total = <?php echo json_encode($consumo) ?>;
          new Chart(document.getElementById("line-chart"), {
            ...
            options: {
              ...
              plugins: {
                ...
                title: {
                  display: true,
                  text: 'CONSUMO ENERGÉTICO TOTAL EN MAYO 2023 (kwh)',
                  padding: {
                  top: 10,
                  bottom: 30
                  }
        ...
        <script type="text/javascript">
          const consumo_ofi = <?php echo json_encode($consumo_salas_oficinas) ?>;
          const consumo_com = <?php echo json_encode($consumo_salas_comunes) ?>;
          const consumo_work = <?php echo json_encode($consumo_salas_workspace) ?>;
          const consumo_reun = <?php echo json_encode($consumo_salas_reunion) ?>;
            ...
            options: {
              plugins: {
                title: {
                  display: true,
                  text: 'CONSUMO TOTAL POR SALAS (kwh)'
                },
              },
              responsive: true,
              scales: {
      ...
      <br>
        <section class="grid">  
          ...
          <script type="text/javascript">
            const consumo_s1 = <?php echo json_encode($consumo_sala_1) ?>;   
            new Chart(document.getElementById("mixed-chart"), {
                ...
                options: {
                  ...
                  plugins: {
                    ...
                    title: {
                      display: true,
                      text: 'CONSUMO ENERGÉTICO SALA 1 (kwh)',
                      padding: {
                      top: 10,
                      bottom: 30
                      }
...
<script type="text/javascript">
  const consumo_s2 = <?php echo json_encode($consumo_sala_2) ?>; 
            new Chart(document.getElementById("mixed-chart2"), {
                ...
                options: {
                  ...
                  plugins: {
                    ...
                    title: {
                      display: true,
                      text: 'CONSUMO ENERGÉTICO SALA 2',
                      padding: {
                      top: 10,
                      bottom: 30
                      }
...
<script type="text/javascript">
  const consumo_s3 = <?php echo json_encode($consumo_sala_3) ?>; 
            new Chart(document.getElementById("mixed-chart3"), {
                ...
                options: {
                  ...
                  plugins: {
                    ...
                    title: {
                      display: true,
                      text: 'CONSUMO ENERGÉTICO SALA 3',
                      padding: {
                      top: 10,
                      bottom: 30
                      }
...
<script type="text/javascript">
  const consumo_s4 = <?php echo json_encode($consumo_sala_4) ?>; 
            new Chart(document.getElementById("mixed-chart4"), {
                ...
                options: {
                  ...
                  plugins: {
                    ...
                    title: {
                      display: true,
                      text: 'CONSUMO ENERGÉTICO SALA 4',
                      padding: {
                      top: 10,
                      bottom: 30
                      }
...
<script type="text/javascript">
  const consumo_s5 = <?php echo json_encode($consumo_sala_5) ?>; 
            new Chart(document.getElementById("mixed-chart5"), {
                ...
                options: {
                  ...
                  plugins: {
                    ...
                    title: {
                      display: true,
                      text: 'CONSUMO ENERGÉTICO SALA 5',
                      padding: {
                      top: 10,
                      bottom: 30
                      }
...
<script type="text/javascript">
  const consumo_s6 = <?php echo json_encode($consumo_sala_6) ?>; 
            new Chart(document.getElementById("mixed-chart6"), {
                ...
                options: {
                  ...
                  plugins: {
                    ...
                    title: {
                      display: true,
                      text: 'CONSUMO ENERGÉTICO SALA 6',
                      padding: {
                      top: 10,
                      bottom: 30
                      }
...
<script type="text/javascript">
  const consumo_s7 = <?php echo json_encode($consumo_sala_7) ?>; 
            new Chart(document.getElementById("mixed-chart7"), {
                ...
                options: {
                  ...
                  plugins: {
                    ...
                    title: {
                      display: true,
                      text: 'CONSUMO ENERGÉTICO SALA 7',
                      padding: {
                      top: 10,
                      bottom: 30
                      }
...
<script type="text/javascript">
  const consumo_s8 = <?php echo json_encode($consumo_sala_8) ?>; 
            new Chart(document.getElementById("mixed-chart8"), {
                ...
                options: {
                  ...
                  plugins: {
                    ...
                    title: {
                      display: true,
                      text: 'CCONSUMO ENERGÉTICO SALA 8',
                      padding: {
                      top: 10,
                      bottom: 30
                      }
...
<script type="text/javascript">
      ...
      <script type="text/javascript">
            ...
            const consumo_s7 = <?php echo json_encode($consumo_sala_7) ?>; 
            const consumo_s8 = <?php echo json_encode($consumo_sala_8) ?>; 
            const sum1 = consumo_s1.reduce(function(a, b){
                  return a + b;
                });
            const sum2 = consumo_s2.reduce(function(a, b){
              return a + b;
            });
            const sum3 = consumo_s3.reduce(function(a, b){
              return a + b;
            });
            const sum4 = consumo_s4.reduce(function(a, b){
              return a + b;
            });
            const sum5 = consumo_s5.reduce(function(a, b){
              return a + b;
            });
            const sum6 = consumo_s6.reduce(function(a, b){
              return a + b;
            });
            const sum7 = consumo_s7.reduce(function(a, b){
              return a + b;
            });
            const sum8 = consumo_s8.reduce(function(a, b){
              return a + b;
            });
